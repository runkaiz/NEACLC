    ...
    >
        ...
        <a href="#" class="text-gray-400 hover:text-gray-300">
          ...
          <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://github.com/runkaiz/NEACLC" class="text-gray-400 hover:text-gray-300">
        ...
        <p class="mt-8 text-center text-base text-gray-400">&copy; 2022 Runkai Zhang</p>
    </div>
</footer>
